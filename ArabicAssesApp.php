				...
				<div class="js-container english-main-con">
					...
					<div class="row home-sub-con">
							...
							<div class="col-sm-6">
								...
								<p class="home-header-arabic-desc" style="direction: rtl;">قد يبدو للبعض منكم أن اللغة العربية صعبة الإتقان وأنه لكي تكون اللغة سليمة؛ يجب أن تحتوي على تراكيب معقدة وغامضة وعلى صاحبها تعلُّم قواعد جافة لا يعرف كيفية استخدامها، وبالطبع هذا المفهوم ليس سوى صورة نمطية والعديد بحاجة إلى تصحيحها، وبذلك وضع فريق لوك إن مينا اختبار اللغة العربية لأجلكم، وقد استهدفنا من خلاله توظيف مصطلحات شائعة الاستخدام وابتعدنا قدر الإمكان عن الأسئلة التي قد تبدو بعيدة عن الاستخدام العام، ويتضمن 50 سؤالًا مع إجاباتهم الصحيحة وبعد اجتيازهم تظهر لكم بعض النصائح لتحسين لغتكم وفي حال إعادته؛ تظهر أسئلة جديدة، ومن ثَمَّ نرجو أن نحقق لكم فوائد عملية كما نفعل وكما تنتظروه منا دومًا..</p>
